...
ICON_SOURCE="$ROOT_DIR/iconikai-icon-pack/ios/AppIcon-1024.png"
ICONSET="$ROOT_DIR/.build/$APP_NAME.iconset"
...
iconutil -c icns "$ICONSET" -o "$APP_RESOURCES/$APP_NAME.icns"
